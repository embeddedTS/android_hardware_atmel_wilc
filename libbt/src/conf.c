...
static const conf_entry_t conf_table[] = {
	...
	{"BtBdAddress", userial_set_bt_bd_addr , 0},
	{"EnableBDAddressChange", userial_set_enable_bd_address_change , 0},
#if (VENDOR_LIB_RUNTIME_TUNING_ENABLED == TRUE)
    {"FwPatchSettlementDelay", hw_set_patch_settlement_delay, 0},
#endif
	{"PowerSaveEnabled", userial_set_bluetooth_powersave, 0},
	{"PowerSaveTimeout", userial_set_bluetooth_timeout, 0},
