...
#define BLUETOOTH_UART_DEVICE_PORT      "/dev/ttymxc1"     /*originally ttyHS2*/ /* maguro */
#endif
...
#define USE_CONTROLLER_BDADDR   TRUE //atmel The BDADDR should be stored in the chip, and read from the controller
#endif
